                ...
                request.then(function (data) {
                    if (data == "1") {
                        ...
                        if (cf.find('textarea').val().length < 20) {
                            text = "Il messaggio deve contenere almeno 20 caratteri!"
                        }
                    ...
                    $('.message_container').html('<div class="alert_box r_corners error"><i class="fa fa-exclamation-triangle"></i><p>Errore di connessione!</p></div>')
                        .delay(150)
                        .slideDown(300)
                        .delay(4000)
                        .slideUp(300, function () {
