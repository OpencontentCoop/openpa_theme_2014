<div class="main-nav" role="navigation">
    ...
    {else}
        <ul class="horizontal_list main_menu clearfix">{def $top_menu_node_ids = openpaini( 'TopMenu', 'NodiCustomMenu', array() )}
            <li class="menu-item firstli">
                <a title="Link a homepage" class="home" href={'/'|ezurl()}><b>Home</b></a>
            </li>
