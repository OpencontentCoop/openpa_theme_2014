...
<script type="text/javascript" language="javascript" class="init">
    var mainQuery = "{concat( '(raw[', solr_meta_subfield('evento_vita','id'), '] = ', $node.contentobject_id, ' or raw[', solr_meta_subfield('evento_vita','main_parent_node_id'), '] = ', $node.node_id, ')')}";
    ...
    var facets = [
        ...
        {field: 'evento_vita.name', 'limit': 300, 'sort': 'alpha', name: 'Evento della vita'}
    ];
