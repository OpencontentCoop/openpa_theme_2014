{if $fields}
  ...
  <div class="table-responsive">
	  <table class="table table-striped list">
	  		<caption>Elenco di oggetti di tipo {$class.name|wash()}</caption>
		  <thead>
			  <tr>
