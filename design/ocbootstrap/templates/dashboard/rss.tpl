...
<tr>
    ...
    <td class="{$RSSExport:sequence}" width="1"><div class="listbutton"><a href={concat("rss/edit_export/",$RSSExport:item.id)|ezurl} class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a></div></td>
...
<tr>
  ...
  <td align="right">
    <button type="submit" name="RemoveExportButton" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> {'Remove'|i18n('design/standard/rss/list')}</button>
  </td>
</tr>
</table>
...
<tr>
  ...
  <td align="right">    
    <button type="submit" name="RemoveImportButton" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> {'Remove'|i18n('design/standard/rss/list')}</button>
  </td>
</tr>
</table>
