...
<p><input placeholder="{'Text'|i18n( 'design/standard/content/datatype' )}"id="{$id_base}_text" class="{$html_class}" class="{$html_class}" type="text" name="{$attribute_base}_ezurl_text_{$attribute.id}" value="{$attribute.data_text|wash( xhtml )}" /></p>
