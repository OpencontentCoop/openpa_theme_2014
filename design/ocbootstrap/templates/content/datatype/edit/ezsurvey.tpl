...
<fieldset>
  ...
  <div class="form-group">
	  ...
	  <input class="form-control" name="{$prefixAttribute}_ezsurvey_redirect_submit_{$attributeID}" size="30" value="{$survey.redirect_submit|wash('xhtml')}" />
  </div>
			...
			<div class="checkbox">
			  <label>
				{section show=$:item.can_be_selected}
				  <input name="{$prefixAttribute}_ezsurvey_question_{$:item.id}_selected_{$attributeID}" type="checkbox" />
				{/section}
		  ...
		  <div class="col-md-4">
			<div class="form-group">
			  <div class="input-group">
				...
				<input class="form-control" type="text" size="2" name="{$prefixAttribute}_ezsurvey_question_tab_order_{$:item.id}_{$attributeID}" value="{$:item.tab_order}" />
			  </div>
			</div>			
		  </div>
		  <div class="col-md-3">
			<div class="checkbox">
			  <label>
				<input type="checkbox" name="{$prefixAttribute}_ezsurvey_question_visible_{$:item.id}_{$attributeID}"{section show=$:item.visible|eq(1)} checked="checked"{/section} /> {"Visible"|i18n('survey')}
			  </label>
			</div>
		  </div>		  
		  <div class="col-md-3">		
			<button type="submit" class="btn btn-md" name="CustomActionButton[{$attributeID}_ezsurvey_question_copy_{$:item.id}]">
			  <img src={"copy.gif"|ezimage()} /> Duplica
			</button>
		  </div>		  
		</div>
	  </div>	
