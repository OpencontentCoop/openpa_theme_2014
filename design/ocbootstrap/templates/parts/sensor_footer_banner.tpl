  ...
  <div style="height: 79px;position: absolute;right: 0;top: 0;width: 20%;background-image:url('{'sensor_banner/bg_dark.png'|ezimage(no)}')"></div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-9 col-sm-6 text-center" style="position: relative">
                {if $banner.data_text|ne('')}
				<p style="margin: 0px; position: absolute; font-size: 1.2em; bottom: 0px; white-space: nowrap; z-index: 2147483647;" class="hidden-sm">{$banner.data_text|wash()}</p>
				{/if}
